...
export function tierLabel(t) {
  return t === 1 ? "Tier 1 · Schoon digitaal" : t === 2 ? "Tier 2 · Misleidend formaat" : "Tier 3 · Scans & foto's";
}
...
export function displayFields(doc) {
  ...
  if (e.goods) push("Goederen", e.goods);
  if (e.lines != null) push("Regels", String(Array.isArray(e.lines) ? e.lines.length : e.lines));
